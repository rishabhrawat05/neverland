...
function split(){
  ...
  document.querySelector("#page>h5").textContent.split("").forEach(function(char){
    hover +=`<span>${char}</span>`
  })
  document.querySelector("#man>h5").textContent.split("").forEach(function(char){
    tum +=`<span>${char}</span>`
  })
  document.querySelector("#man>h2").textContent.split("").forEach(function(char){
    hum +=`<span>${char}</span>`
  })
  document.querySelector("#team>h2").textContent.split("").forEach(function(char){
    dum +=`<span>${char}</span>`
  })
  document.querySelector("#team>h5").textContent.split("").forEach(function(char){
    to +=`<span>${char}</span>`
  })
  document.querySelector("#page5>#div>h2").textContent.split("").forEach(function(char){
    ct +=`<span>${char}</span>`
  })
  
  document.querySelector("#page>h1").innerHTML=clutter;
  document.querySelector("#page>h5").innerHTML=hover;
  document.querySelector("#man>h5").innerHTML=tum;
  document.querySelector("#man>h2").innerHTML=hum;
  document.querySelector("#team>h2").innerHTML=dum;
  document.querySelector("#team>h5").innerHTML=to;
  document.querySelector("#page5>#div>h2").innerHTML=ct;
...
gsap.to("#page>h5>span",{
  scrollTrigger:{
    trigger:"#page>h5>span",
    scroller:"#main",
    start:`top 10%`,
    scrub:0.8,
    end:"100% top"
...
gsap.from("#team>h5>span",{
  scrollTrigger:{
    trigger:"#team>h5>span",
    scroller:"#main",
    scrub:2,
...
gsap.from("#team>h2>span",{
  scrollTrigger:{
    trigger:"#team>h2>span",
    scroller:"#main",
    scrub:2,
...
canvas1()
gsap.from("#page5>#div>h2>span",{
  opacity:0,
  stagger:.1,
  scrollTrigger:{
    trigger:"#page5>#div>h2>span",
    start:"8700% top",
    scroller:"#main",
    end:"8900% top",
    scrub:1,
